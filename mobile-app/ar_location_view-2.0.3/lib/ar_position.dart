...
class ArPosition {
  /// Constructs an instance with the given values for testing. [ArPosition]
  ...
  bool operator ==(Object other) {
    var areEqual = other is ArPosition &&
  ...
  /// Converts the supplied [Map] to an instance of the [ArPosition] class.
  static ArPosition fromMap(dynamic message) {
  ...
  /// Converts the [ArPosition] instance into a [Map] instance that can be
  /// serialized to JSON.
