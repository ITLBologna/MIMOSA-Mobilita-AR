...
class NextRunsService implements INextRunsService {
  @override
  Future<Validation<Runs>> getNextRuns({required String routeId, required String stopId,required int nResults,}) {
    final iApiService = serviceLocator.get<IApisService>();
    return iApiService.getNextRuns(routeId: routeId, stopId: stopId, nResults: nResults, useCache: false);
  }
}